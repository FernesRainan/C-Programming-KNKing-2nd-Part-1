...
represent White pieces, and the letters k, q, r, b, n and p represent Black pieces.
evaluate_position shoud sum the values of the White pieces ( Q=9, R=5, B=3, N=3, P=1). 
It should also sum the values of the Black pieces (done in a similar way). 
The function will return the difference between the two numbers. This value will be positive if
