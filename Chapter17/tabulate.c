...
// functions (all three belong to <math.h>)
              ...
              double last, double incr)
{
	...
	num_intervals = ceil ((last-first) / incr);  // When given an argument x of double type, ceil returns 
	                                             // the smallest integer that's greater than or equal to x
