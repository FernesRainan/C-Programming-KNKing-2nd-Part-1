// Modify the inventory.c program of Section 16.3 so that the inventory array is allocated
// dynamically and later reallocated when it fills up. Use malloc initially to allocate
...
//         database. Prints an error mesage and returns
...
// print: Prints a listing of al parts in the database
